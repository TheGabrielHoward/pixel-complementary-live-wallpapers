...
ui_print "Downloading module files for '"$DEVICE"' and Android Version '"$RELEASE"'"
  ...
  if [[ $? -eq 0 ]]; then
    ...
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/walleye/NexusWallpapersStubPrebuilt2017/NexusWallpapersStubPrebuilt2017.apk -o $TMPDIR/$RELEASE/walleye/NexusWallpapersStubPrebuilt2017/NexusWallpapersStubPrebuilt2017.apk
    mkdir -p $TMPDIR/$RELEASE/blueline/NexusWallpapersStubPrebuilt2018
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/NexusWallpapersStubPrebuilt2018/NexusWallpapersStubPrebuilt2018.apk -o $TMPDIR/$RELEASE/blueline/NexusWallpapersStubPrebuilt2018/NexusWallpapersStubPrebuilt2018.apk
    mkdir -p $TMPDIR/$RELEASE/flame/NexusWallpapersStubPrebuilt2019
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/NexusWallpapersStubPrebuilt2019/NexusWallpapersStubPrebuilt2019.apk -o $TMPDIR/$RELEASE/flame/NexusWallpapersStubPrebuilt2019/NexusWallpapersStubPrebuilt2019.apk

    mkdir -p $TMPDIR/$RELEASE/walleye/WallpapersBReel2017/lib/arm64
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/walleye/WallpapersBReel2017/WallpapersBReel2017.apk -o $TMPDIR/$RELEASE/walleye/WallpapersBReel2017/WallpapersBReel2017.apk
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/walleye/WallpapersBReel2017/lib/arm64/libgdx.so -o $TMPDIR/$RELEASE/walleye/WallpapersBReel2017/lib/arm64/libgdx.so
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/walleye/WallpapersBReel2017/lib/arm64/libwallpapers-breel-jni.so  -o $TMPDIR/$RELEASE/walleye/WallpapersBReel2017/lib/arm64/libwallpapers-breel-jni.so

    mkdir -p $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/lib/arm64 $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/oat/arm64
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/WallpapersBReel2018/WallpapersBReel2018.apk -o $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/WallpapersBReel2018.apk
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/WallpapersBReel2018/lib/arm64/libgdx.so -o $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/lib/arm64/libgdx.so
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/WallpapersBReel2018/lib/arm64/libwallpapers-breel-2018-jni.so -o $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/lib/arm64/libwallpapers-breel-2018-jni.so
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/WallpapersBReel2018/oat/arm64/WallpapersBReel2018.odex -o $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/oat/arm64/WallpapersBReel2018.odex
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/blueline/WallpapersBReel2018/oat/arm64/WallpapersBReel2018.vdex -o $TMPDIR/$RELEASE/blueline/WallpapersBReel2018/oat/arm64/WallpapersBReel2018.vdex

    mkdir -p $TMPDIR/$RELEASE/flame/WallpapersBReel2019/lib/arm64 $TMPDIR/$RELEASE/flame/WallpapersBReel2019/oat/arm64
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/WallpapersBReel2019/WallpapersBReel2019.apk -o $TMPDIR/$RELEASE/flame/WallpapersBReel2019/WallpapersBReel2019.apk
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/WallpapersBReel2019/lib/arm64/libgdx.so -o $TMPDIR/$RELEASE/flame/WallpapersBReel2019/lib/arm64/libgdx.so
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/WallpapersBReel2019/oat/arm64/WallpapersBReel2019.odex -o $TMPDIR/$RELEASE/flame/WallpapersBReel2019/oat/arm64/WallpapersBReel2019.odex
    $MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/WallpapersBReel2019/oat/arm64/WallpapersBReel2019.vdex -o $TMPDIR/$RELEASE/flame/WallpapersBReel2019/oat/arm64/WallpapersBReel2019.vdex

    #mkdir -p $TMPDIR/$RELEASE/flame/PixelLiveWallpaperPrebuilt/oat/arm64
    #$MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/PixelLiveWallpaperPrebuilt/PixelLiveWallpaperPrebuilt.apk -o $TMPDIR/$RELEASE/flame/PixelLiveWallpaperPrebuilt/PixelLiveWallpaperPrebuilt.apk
    #$MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/PixelLiveWallpaperPrebuilt/oat/arm64/PixelLiveWallpaperPrebuilt.odex -o $TMPDIR/$RELEASE/flame/PixelLiveWallpaperPrebuilt/oat/arm64/PixelLiveWallpaperPrebuilt.odex
    #$MODPATH/curl -k -L https://gitlab.com/thegabrielhoward/pixel-complementary-live-wallpapers/raw/master/$RELEASE/$SECURITY_PATCH_VERSION_PIXEL/flame/PixelLiveWallpaperPrebuilt/oat/arm64/PixelLiveWallpaperPrebuilt.vdex -o $TMPDIR/$RELEASE/flame/PixelLiveWallpaperPrebuilt/oat/arm64/PixelLiveWallpaperPrebuilt.vdex
